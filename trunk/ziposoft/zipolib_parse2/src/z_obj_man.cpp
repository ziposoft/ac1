...
z_status zo_manipulator::access_obj_child(zo_fet_man_context* context, void* pchild)
{
	ZTFP("void* pchild");
...
z_status zo_manipulator::feature_callback(zo_fet_man_context* context,zo_fet_opt options,void& Obj)
{
	ZTFP("void& Obj");
	switch(context->_oper)
	{
...
z_status zo_manipulator::feature_callback(zo_fet_man_context* context,zo_fet_opt options,void** p_child_obj)
{
	ZTFP("void** pObj");
	switch(context->_oper)
	{
...
z_status zo_manipulator::feature_callback_pchild(zo_fet_man_context* context,zo_fet_opt options,void* p_child_obj)
{
	ZTFP("void* pObj");
	switch(context->_oper)
	{
...
z_status zo_manipulator::feature_callback(zo_fet_man_context* context,zo_fet_opt options,void& member_var)
{
	...
	{
		_p_member_var_obj=(void*)member_var.get_next_obj();
	...
	case zo_mvo_set_from_value:
		{
			...
			void_parse* op=0;
			while( (op=(void_parse*)context->_p_assignment_value->_child_list.get_next_obj()) )
			{
...
z_status zo_manipulator::feature_execute(void* p_obj,zo_ftr_entry* fe)
{
	ZTF;
...
z_status zo_manipulator::feature_display(void* p_obj,zo_ftr_entry* fe)
{
	ZTF;
...
ctext zo_manipulator::feature_get_as_string(void* p_obj,zo_ftr_entry* fe)
{
	ZTF;
...
z_status zo_manipulator::feature_set_from_value(void* p_obj,zp_value* p_value_obj,zo_ftr_entry* fe)
{
	ZTF;
